// Archivo Mapa java del paquete modelo
...
public class Mapa {
    ...
    // CAMBIO se agrego para saber si Pac Man esta sobre comida
    ...
    // Verifica si en una posicion hay una vida extra
    ...
    // Verifica si todavia queda comida en el mapa
    public boolean quedaComida() {
            ...
            for (int fila = 0; fila < matriz.length; fila++) {
                ...
                for (int columna = 0; columna < matriz[fila].length; columna++) {
                    ...
                    // Si encuentra una comida todavia no ha terminado el juego
            ...
            // Si no encontro comida el jugador gano
            return false;
    }

    // CAMBIO se agrego para eliminar comida cuando Pac Man la come
