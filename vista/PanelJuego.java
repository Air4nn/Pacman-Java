...
public class PanelJuego extends JPanel {
    ...
    private void dibujarDecoracionInicio(Graphics g) {
        ...
        g.fillOval(centroX - 130, y + 20, 10, 10);
        g.fillOval(centroX - 95, y + 20, 10, 10);
        g.fillOval(centroX - 60, y + 20, 10, 10);
    ...
    // Dibuja un fantasma decorativo con ojos
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!partidaIniciada) {
            ...
            // Título siempre centrado y un poco arriba
            ...
            int yOpcion1 = yTitulo + 90;
            int yOpcion2 = yTitulo + 130;

            // ======================
            // OPCION INICIAR PARTIDA
            // ======================
            ...
            // Dibujar decoración inferior de Pac-Man y fantasmas
        ...
        for (int fila = 0; fila < matriz.length; fila++) {
            for (int columna = 0; columna < matriz[fila].length; columna++) {
                ...
                // Dibujar comida más pequeña, estilo Pac-Man clásico
        ...
        // Mostrar puntaje, high score, tiempo y vidas
