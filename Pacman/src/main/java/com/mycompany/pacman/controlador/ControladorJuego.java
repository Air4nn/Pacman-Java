...
public class ControladorJuego {
    ...
    private void verificarComida() {
        ...
        // Verifica si Pac-Man está sobre una vida extra
        ...
        // Verifica si Pac-Man comió una super bolita
    ...
    for (int i = 0; i < fantasmas.length; i++) {
        ...
        // Verifica si algún fantasma ocupa la misma posición que Pac-Man
        if (fantasmas[i].getX() == pacman.getX() &&
            ...
            if (pacman.tieneSuperPoder()) {
                ...
                // El fantasma regresa a la posición inicial
                ...
                if (pacman.estaMuerto()) {
                    ...
                    // Si aún quedan vidas,
                    // Pac-Man vuelve a la posición inicial
            ...
            // Se sale del ciclo para evitar procesar más colisiones
            // durante esta actualización del juego
            break;
        }
    }
}
