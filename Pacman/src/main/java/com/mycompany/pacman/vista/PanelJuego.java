...
public class PanelJuego extends JPanel {
    ...
    // Puntaje más alto guardado
    private int highScore = 0;

    // Tiempo transcurrido en segundos
    private int segundosJuego = 0;

    // Indica si la partida ya inició
    private boolean partidaIniciada = false;

    // Fuente estilo arcade
    private Font fuenteArcade;

    // Opción seleccionada en el menú inicial
    // 0 = Iniciar partida
    // 1 = Salir
    ...
    public PanelJuego(Mapa mapa, Pacman pacman, Fantasma[] fantasmas) {
        ...
        try {
            ...
            // Si la fuente no carga, se usa una fuente básica como respaldo
    ...
    // Cambia si la partida ya inició o no
    public void setPartidaIniciada(boolean partidaIniciada) {
        this.partidaIniciada = partidaIniciada;
    }

    // Cambia visualmente la opción seleccionada del menú inicial
    public void setOpcionSeleccionada(int opcionSeleccionada) {
        this.opcionSeleccionada = opcionSeleccionada;
    }

    // Cambia el número que se muestra en la cuenta regresiva
    public void setCuentaRegresiva(int cuentaRegresiva) {
        this.cuentaRegresiva = cuentaRegresiva;
    }

    // Dibuja una decoración en la pantalla de inicio
    // Siempre queda abajo y centrada sin importar el tamaño del mapa
    private void dibujarDecoracionInicio(Graphics g) {

        // Posición base centrada
        int centroX = getWidth() / 2;

        // Posición vertical cerca de la parte inferior
        int y = getHeight() - 155;

        // Tamaño de los dibujos decorativos
        int tamPacman = 55;
        int tamFantasma = 45;
        ...
        // Fantasmas decorativos con colores clásicos
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Pantalla de inicio.
        // Si la partida todavía no ha iniciado, solo se muestra esta pantalla
        ...
        if (!partidaIniciada) {
            ...
            // Hace que el título parpadee cada medio segundo
            ...
            if (mostrarTitulo) {
                ...
                // Título centrado y un poco más arriba del centro
            ...
            // Si la opción seleccionada es iniciar, se dibujan flechas a los lados
            if (opcionSeleccionada == 0) {
                opcion1 = "<  INICIAR PARTIDA  >";
            }

            // Si la opción seleccionada es salir, se dibujan flechas a los lados
            ...
            // Color de la opción Iniciar Partida
            if (opcionSeleccionada == 0) {
                g.setColor(Color.YELLOW);
            } else {
                g.setColor(Color.WHITE);
            ...
            // Decoración inferior de Pac-Man y fantasmas
            ...
            // Sale del método para no dibujar el mapa detrás de la pantalla de inicio
            return;
        }
        ...
        for (int fila = 0; fila < matriz.length; fila++) {
            for (int columna = 0; columna < matriz[fila].length; columna++) {
                ...
                // Convertir posición de matriz a píxeles
                ...
                // Dibujar comida normal como punto pequeño
                if (matriz[fila][columna] == Mapa.COMIDA) {
                    g.setColor(Color.WHITE);
                    g.fillOval(x + 11, y + 11, 6, 6);
                }

                // Dibujar vida extra como un corazón simple
                ...
                // Dibujar super bolita más grande
        ...
        // Ángulo inicial de la boca
        int anguloInicio = 30;

        // La boca cambia de dirección según el movimiento de Pac-Man
        ...
        // Si la boca está abierta, se dibuja un arco
        if (bocaAbierta) {
            g.fillArc(px, py, TAM_CELDA, TAM_CELDA, anguloInicio, 300);
        }

        // Si la boca está cerrada, se dibuja un círculo completo
        else {
    ...
    public Dimension getPreferredSize() {
        ...
        // Calcula el tamaño ideal del panel según el tamaño del mapa
